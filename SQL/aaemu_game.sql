/*
 ...
 Source Schema         : aaemu_game2017

 Target Server Type    : MySQL
 Target Server Version : 80012
 File Encoding         : 65001

 Date: 10/03/2021 16:36:47
*/
...
CREATE TABLE `cash_shop_item`  (
  ...
  `uniq_id` int(11) UNSIGNED NULL DEFAULT 0 COMMENT '唯一ID',
  ...
  `item_template_id` int(11) UNSIGNED NULL DEFAULT 0 COMMENT '物品模板id',
  ...
  `buy_id` int(11) UNSIGNED NULL DEFAULT 0,
  ...
  `price` int(11) UNSIGNED NULL DEFAULT 0 COMMENT '价格',
  `remain` int(11) UNSIGNED NULL DEFAULT 0 COMMENT '剩余数量',
  `bonus_type` int(11) UNSIGNED NULL DEFAULT 0 COMMENT '赠送类型',
  `bouns_count` int(11) UNSIGNED NULL DEFAULT 0 COMMENT '赠送数量',
  `cmd_ui` tinyint(1) UNSIGNED NULL DEFAULT 0 COMMENT '是否限制一人一次',
  `item_count` int(11) UNSIGNED NULL DEFAULT 1 COMMENT '捆绑数量',
  ...
  `dis_price` int(11) UNSIGNED NULL DEFAULT 0 COMMENT '当前售价',
  PRIMARY KEY (`id`) USING BTREE
